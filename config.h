...
static const char col_gray1[]       = "#19191a";
static const char col_gray2[]       = "#232730";
static const char col_gray3[]       = "#D8DEE9";
static const char col_gray4[]       = "#ECEFF4";
static const char col_cyan[]        = "#300b28";
...
static const char *const autostart[] = {
  ...
  "alacritty", NULL,
  "dunst", NULL,
  "picom", "-b", "--vsync", "--backend", "glx", NULL,
  "nvidia-settings", "-a", "'AllowFlipping=0'", NULL,
  "sh", "-c", "$HOME/git/dwm-mine/scripts/fehbg.sh", NULL,
  "nm-applet", NULL,
  "sh", "-c", "$HOME/git/dwm-mine/scripts/status", NULL,
  "sh", "-c", "$HOME/git/dwm-mine/scripts/dbus", NULL,
  NULL /* terminate */
};

/* tagging */
static const char *tags[] = { "dev", "web", "file", "med", "ext" };
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_z,       spawn,          SHCMD ("$HOME/git/dwm-mine/scripts/fehbg.sh") },
        { MODKEY|ControlMask,           XK_w,       spawn,          SHCMD ("brave")},
        { MODKEY,                       XK_w,       spawn,          SHCMD ("thorium")},
        { 0,                            XK_Print,   spawn,          SHCMD ("$HOME/git/dwm-mine/scripts/screenshot.sh")},
	{ MODKEY,                       XK_e,       spawn,          SHCMD ("thunar")},
        { MODKEY,                       XK_space,   spawn,          SHCMD ("$HOME/git/dwm-mine/scripts/en-fa.sh")},
